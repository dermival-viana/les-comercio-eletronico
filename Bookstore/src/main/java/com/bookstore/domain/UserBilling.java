...
@Entity
public class UserBilling extends DomainEntity {
	...
	private String userBillingNumber;
	private String userBillingNeighborhood;
	...
	public String getUserBillingNumber() {
		return userBillingNumber;
	}

	public void setUserBillingNumber(String userBillingNumber) {
		this.userBillingNumber = userBillingNumber;
	}

	public String getUserBillingNeighborhood() {
		return userBillingNeighborhood;
	}

	public void setUserBillingNeighborhood(String userBillingNeighborhood) {
		this.userBillingNeighborhood = userBillingNeighborhood;
	}
}
